...
# Create two empty lists to start
'''
names = []
grades = []

while True:
    print("type 1 if you want to add Student and Grade")
    print("type 2 if you want to Show All Students")
    print("type 3 if you want to Show Class Stats (Average, High, Low)")
